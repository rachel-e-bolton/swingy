...
public class HeroView {
    public void PrintPosition(Hero hero) {
        System.out.println("\nYou are at position: [" + TextColors.ANSI_CYAN + hero.get_rowPosition() + TextColors.ANSI_RESET + "," + TextColors.ANSI_CYAN + hero.get_colPosition() + TextColors.ANSI_RESET + "]");
    }
    ...
    public void PrintWinMap(Hero hero) {
        System.out.println("\nCongratulations, " + TextColors.ANSI_PURPLE + hero.get_name() + TextColors.ANSI_RESET + "!");
        System.out.println("You've made OFF of this map and scored some XP.\nGet ready to land on your next map...\n");
    }
}
